...
angular.module('bahmni.home')
    .controller('LoginLocationController', ['$rootScope', '$scope', '$window', '$location', 'sessionService', 'initialData', 'spinner', '$q', '$stateParams', '$bahmniCookieStore', 'localeService', '$translate', 'userService', 'auditLogService', 'rtlService',
        function ($rootScope, $scope, $window, $location, sessionService, initialData, spinner, $q, $stateParams, $bahmniCookieStore, localeService, $translate, userService, auditLogService, rtlService) {
            ...
            // Initialize RTL direction on controller load
            rtlService.initialize();

            // Setup language change watcher for RTL
            rtlService.setupLanguageWatcher($scope);
            ...
            $scope.changeLocale = function (locale) {
                ...
                // RTL direction will be automatically applied via the language watcher
            };
        }]);
