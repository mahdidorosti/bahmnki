...
describe('surgicalAppointmentService', function () {
    ...
    it('should get the surgical blocks in the given date range with custom representation', function (done) {
        ...
        expect(mockHttp.get.calls.mostRecent().args[1].params).toEqual({ startDatetime : '2039-08-26T12:00:00.000+0330', endDatetime : '2039-08-26T15:00:00.000+0330', includeVoided: false, activeBlocks: true, v: "custom:(id,uuid," +
